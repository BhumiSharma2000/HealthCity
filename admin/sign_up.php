    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/admin.png');">
                ...
                <div class="col-lg-7 bg-white">
                    <div class="container h-100">
                        ...
                        if(isset($_GET['flag']))
                        {
                            ...
                            {
                                echo "<center><font style='color:red; text-align:center;font-size:20px'><b>Incorrect Details...</b></font></center><br/>";
