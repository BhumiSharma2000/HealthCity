    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/admin2.png');">
                    <div class="d-flex h-100 p-h-40 p-v-15 flex-column justify-content-between" style="margin-top: 150px">
                        <div>
                            <h1 class="text-white m-b-20 font-weight-normal" ><b style="color: blue">HealthCity</b></h1>
