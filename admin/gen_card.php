...
<?php
    ...
    ?>
                                    ...
                                    <tbody>
                                    	    <?php
    $a=0;
           $q5 = $d->select("user_master","role_id=2");
          //$data = mysqli_query($con,$q);
          $i = 0; 
          
          while( $result = mysqli_fetch_array($q5)){

$qrdata = $result['card_id'];
                                        ...
                                        <tr>
                                         ...
                                         <td><?php echo $result['email']; ?></td>
                                            ...
                                            <td> <a  href="editpatient.php?id=<?php echo $result['login_id']; ?>" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right">
                                                ...
                                                <td><a href="view_aadhar.php?id=<?php echo $result['aadhar']; ?>&&k=<?php echo $result['login_id']; ?>" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right"><i class="anticon anticon-laptop"></i></a></td>
