...
?>
 <div class="page-container">
           ...
           $q5 = $d->select("user_master,laboratary_master","user_master.login_id='$editid' && laboratary_master.login_id='$editid' ");
                                    ...
                                    <div class="col-md-7">
                                        <div class="d-md-flex align-items-center">
                                            ...
                                            <div class="text-center text-sm-left m-v-15 p-l-30">
                                                ...
                                                <p class="text-dark m-b-20">Laboratarist , HealthCity</p>
                                                ...
                                                <ul class="list-unstyled m-t-10">
                                                    ...
                                                    <li class="row">
                                                     ...
                                                     <li class="row">
                                                        ...
                                                        <p class="col font-weight-semibold"> <?php echo $result['license_number']; ?></p>
                                                    </li>
                                                </ul>
