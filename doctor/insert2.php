...
function otpprog($name,$no)
		...
		$reg_no=$no['card_id'];
		$query = "INSERT INTO `patient_master`(`login_id`, `card_id`, `disease_description`, `reason_visit`, `height`, `weight`, `prescription`, `symptoms`, `Report`,`hospital`,`view`) VALUES ('$id','$reg_no','$disease','$reason','$height','$weight',
		'$prescription','$symptom','$report','$hospital','0')";
