                                                   ...
                                                   <select name="report">
                                                    <option selected>select</option>
                                                       ...
                                                       <option value="urine">Urine Routine and Micro...</option>
                                                        ...
                                                        <option value="pet">Positron Emission Tomography</option>
                                                        <option value="tcs">Thallium Cardiac Stress Test</option>
                                                        <option value="Mammography">Mammography</option>
                                                         <option value="bone">Bone Scan</option>
                                                          <option value="mra">MRA</option>
                                                          <option value="Fluotoscopy">Fluotoscopy</option>
                                                          <option value="uroscopy">urinalysis/uroscopy</option>
                                                          <option value="toxi">toxicology test</option>
                                                          <option value="angiography">angiography</option>
                                                          <option value="toxicology">toxicology test</option>
                                                          <option value="thoracentesis">thoracentesis</option>
                                                          <option value="syphilis">syphilis test</option>
                                                          <option value="ECG">protein-bound iodine test</option>
                                                          <option value="prenantal">prenantal testing</option>
                                                          <option value="pregnancy">pregnancy test</option>
                                                          <option value="phenolsulfonphthalein">phenolsulfonphthalein test</option>
                                                          <option value="Pap">Pap smear</option>
                                                          <option value="malabsorption">malabsorption test</option>
                                                          <option value="lumbar">lumbar puncture</option>
                                                          ...
                                                          <option value="thymol">thymol turbidity</option>
