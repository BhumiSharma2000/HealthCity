            ...
            <div class="page-container">
                ...
                ?>      
						            <tr>
						                ...
						                <td><button class="btn btn-success btn-tone m-r-5" style="margin-left:20px;" onclick="window.location='request.php?id=<?php echo $id['login_id'];?>'">View Details</button></td>
						            </tr>
						           <?php
						           $a++;
						       }
